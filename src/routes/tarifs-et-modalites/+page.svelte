      ...
      <table class="table">
        <tbody class="align-top">
          ...
          <tr class="border-none md:border-1">
            ...
            <td class="pb-0" style="padding-bottom: 0;">{#if price.price}{price.price}€&nbsp;/&nbsppers.{/if}</td>
            <td class="text-xs hidden md:table-cell">{@html price.detail}</td>
          </tr>
          <tr>
            <td class="text-xs md:hidden table-cell" style="padding-top: 0" colspan="2">{@html price.detail}</td>
          </tr>
          {/each}
        </tbody>
      </table>
