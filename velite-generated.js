...
export const LinkSchema = s.object({
 text: s.string(),
 url: s.string(),
 color: s.enum(["", "neutral","primary","secondary","dark","black","white"]).optional().nullable(),
 icon_before: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),
 icon_after: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),
...
export const CardSchema = s.object({
 ...
 link: s.object({text: s.string(),url: s.string(),color: s.enum(["", "neutral","primary","secondary","dark","black","white"]).optional().nullable(),icon_before: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_after: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_only: s.boolean().optional().nullable()}).optional().nullable()
})
...
export const PlacesSchema = s.object({
 ...
 name: s.string(),
 image: s.object({src: s.string(),alt: s.string(),legend: s.markdown().optional().nullable()}).optional().nullable(),
 body: s.markdown().optional().nullable(),
...
export const HomeSchema = s.object({
 ...
 cards: s.array(s.object({id: s.string(),featured: s.boolean().optional().nullable(),title: s.string().optional().nullable(),content: s.markdown().optional().nullable(),image: s.object({src: s.string(),alt: s.string(),legend: s.markdown().optional().nullable()}).optional().nullable(),link: s.object({text: s.string(),url: s.string(),color: s.enum(["", "neutral","primary","secondary","dark","black","white"]).optional().nullable(),icon_before: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_after: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_only: s.boolean().optional().nullable()}).optional().nullable()})).optional().nullable(),
...
export const PricelistSchema = s.object({
 seo: s.object({title: s.string(),description: s.string()}),
 cover: s.object({overhead: s.string().optional().nullable(),title: s.string(),text: s.markdown(),image: s.object({src: s.string(),alt: s.string(),legend: s.markdown().optional().nullable()}).optional().nullable(),link: s.object({text: s.string(),url: s.string(),color: s.enum(["", "neutral","primary","secondary","dark","black","white"]).optional().nullable(),icon_before: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_after: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_only: s.boolean().optional().nullable()}).optional().nullable()}),
 prices: s.array(s.object({id: s.string(),name: s.string(),price: s.number().optional().nullable(),detail: s.markdown().optional().nullable()})).optional().nullable(),
 cards: s.array(s.object({id: s.string(),featured: s.boolean().optional().nullable(),title: s.string().optional().nullable(),content: s.markdown().optional().nullable(),image: s.object({src: s.string(),alt: s.string(),legend: s.markdown().optional().nullable()}).optional().nullable(),link: s.object({text: s.string(),url: s.string(),color: s.enum(["", "neutral","primary","secondary","dark","black","white"]).optional().nullable(),icon_before: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_after: s.enum(["", "arrow-left","arrow-right","external-link","facebook","instagram","twitter","calendar","cake","cookie","ice-cream-cone","croissant","cooking-pot","chef-hat","heart","gift","mail","send","star","party-popper","download"]).optional().nullable(),icon_only: s.boolean().optional().nullable()}).optional().nullable()})).optional().nullable(),
 slug: s.path()
})
...
export const EditorSchema = s.object({
 ...
 socials: s.array(s.object({text: s.string(),id: s.string(),icon: s.enum(["", "facebook","twitter","instagram","vimeo"]),url: s.string(),icon_only: s.boolean()})).optional().nullable(),
 address: s.object({name: s.string().optional().nullable(),street: s.string().optional().nullable(),zipcode: s.string(),city: s.string(),country: s.string()}),
